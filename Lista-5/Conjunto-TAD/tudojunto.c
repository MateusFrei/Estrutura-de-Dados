...
int main()
{
    conjunto_inteiro *conjunto = NULL;
    int valor;
    ...
    //B
/*
    conjunto = insere_elemento(valor, conjunto);
    //C

    conjunto = remove_elemento(valor, conjunto);
    //D

    conjunto = uniao_inteiro(conjunto, conjunto);
    //E

    conjunto = interseccao_inteiro(conjunto, conjunto);
    //F

    conjunto = diferenca_inteiro(conjunto, conjunto);
    //G

    conjunto = pertence_inteiro(conjunto, valor);
    //H

    conjunto = Menor_inteiro(conjunto);
    //I

    conjunto = maior_inteiro(conjunto);
    //J

    conjunto = conjunto_igual(conjunto, conjunto);
    //K

    conjunto->tamanho = tamanho(conjunto);
    //L
    if (vazio(conjunto) == 0)
    {
